    ...
    >
      ...
      {file && previewUrl && (
        <div className="relative w-full max-w-xs">
          ...
          {previewUrl.type === "file" && (
            <div className="relative flex items-center gap-2 bg-gray-100 px-3 py-2 rounded-lg shadow">
              <RiFileTextLine />
      ...
      <div className="flex items-center space-x-2 w-full">
        ...
        <button
          ...
          } text-white p-3 rounded-full shadow-md transition flex-shrink-0 cursor-pointer`}
        >
          <RiSendPlane2Fill />
        </button>
      </div>
