...
const CampaignStep2 = ({ data, onNext, onBack }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-4 mb-2">
                {genderOptions.map(({ id, label }) => (
                    <button
                        ...
                        className={`border px-6 py-2 rounded-xl ${formData.gender.includes(id)
                ...
                {[{ label: "Yes", value: true }, { label: "No", value: false }].map(
                    ({ label, value }) => (
                        <button
                            ...
                            className={`border px-6 py-2 rounded-xl capitalize ${formData.shipProducts === value
                                ? "border-[#0D132D] font-semibold"
                                : "border-gray-300"
                                }`}
                        >
            ...
            {/* Targeted Influencers - checkbox list */}
