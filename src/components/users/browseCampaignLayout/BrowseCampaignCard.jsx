...
const CampaignCard = React.memo(
  ({ campaign, handleCardClick, handleSave, setOpenApply, setSelectedCampaignId }) => {
    ...
    return (
      <div
        ...
        className="bg-[#ebf1f7] hover:bg-[#d6e4f6] border border-gray-200 rounded-2xl p-6 shadow-xl/30 hover:shadow-lg transition-transform duration-200 flex flex-col justify-between cursor-pointer relative"
      >
        {/* --- Top Section --- */}
        ...
        <div className="mt-auto flex justify-between items-center border-t border-black pt-4">
          ...
          {campaign.campaignapplied ? (
            <button
              ...
              className="px-5 py-2 text-sm bg-black text-white rounded-full font-semibold hover:bg-gray-900 transition"
            >
              Apply now
            </button>
          ) : (
...
const CampaignCardGrid = React.memo(
  ({ campaigns, loading, handleCardClick, handleSave }) => {
